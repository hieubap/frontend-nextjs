...
const getExtraParamslocation = (filterLocation, extra) => pick(filterLocation, extra);
...
export default function usePaginationLocal(
    ...
    const onChangeOneParamLocation = (param, resetPage = true) => (value) =>
    ...
    return {
        ...
        configTable: {
            ...
            dataSource: content,
            loading: isFetching,
            rowKey: rowKey || ((record) => record.ignoreKey || record.id || record.subscriptionId),
            pagination: {
                current: page,
                pageSize: size,
                total,
